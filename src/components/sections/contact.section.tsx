    ...
    >
      <div className="z-10 flex-1 flex flex-col items-center justify-center">
        <motion.div className="relative mx-4 mb-14 flex flex-col items-center justify-center gap-4 text-center sm:mx-0 sm:flex-row">
          <LayoutTextFlip
            text=""
            words={["A project?", "A collaboration?", "Just want to say hi?"]}
          />
        </motion.div>
        <span className="pointer-events-none bg-gradient-to-b from-black to-gray-400/90 bg-clip-text text-center text-5xl leading-none font-semibold whitespace-pre-wrap text-transparent dark:from-white dark:to-slate-500/10">
          Contact me
        </span>
        <TooltipProvider>
